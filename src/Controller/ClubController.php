...
class ClubController extends AbstractController
{
    ...
    public function listFormation(): Response
    {
        ...
        $formations = array(
            ...
            array(
                'ref' => 'form177', 'Titre' => 'Formation SOA', 'Description' => 'formation theorique', 'date_debut' => '03/12/2020', 'date_fin' => '10/12/2020',
                'nb_participants' => 0
            ),
            array(
    ...
    #[Route('/clubs', name: 'list_club')]

    public function ListClub(ClubRepository $clubRepository)
    {
